...
% ------------------------------------------------------------
\scenenumber{14b --- The Taxonomy Problem}
% ------------------------------------------------------------

\sceneheading{INT. Classification Chamber --- Day}

\begin{action}
A room whose primary function is the resolution of categorical questions --- the assignment of events, persons, jurisdictions, and materials to the correct positions within the administrative system's organizing schema. The schema itself is not present in the room as a visible object; it is distributed across a set of bound registers on the room's shelves, each governing a particular domain of classification, each produced at a different time by different hands, their collective authority presumed to be equivalent though their conventions differ in ways that create, at the margins of each domain, areas where assignment is genuinely underdetermined by the registers themselves.

Several figures are gathered around the central table: a \textsc{Senior Registrar}, two \textsc{Clerks} bearing documents, an \textsc{Assessor} who has been summoned for the specific purpose of resolving the current question, and a \textsc{Witness} whose presence represents the interests of the party whose submission has generated the question. The window behind them gives onto a courtyard where something is actively underway --- the sounds of movement, voices, the displacement of materials --- though the nature of the activity is not immediately legible from within the room.
\end{action}

\begin{action}
The document under consideration describes an event. The event is not in dispute. What is in dispute is which of three overlapping categories the event belongs to for the purpose of the administrative record, since each category determines a different set of obligations, authorities, and subsequent procedures. The categories are not arbitrary; each reflects a genuine aspect of the event, and the question of which aspect should be treated as primary cannot be resolved by reference to the event's nature alone, since the event is the kind of event that is constituted differently depending on the framework within which it is assessed.

The Assessor reads the document with the careful attention of someone who has read many such documents and who understands that the reading itself will not resolve the question but will establish the terms within which the resolution must be sought.
\end{action}

\says{Assessor}{Under the first register it falls within the category of transfer.}

\says{Senior Registrar}{Under the second it would be entered as a disposition.}

\says{First Clerk}{The third register has no provision for either. It would require a supplementary notation.}

\begin{action}
A brief interval. The Witness shifts his position slightly, the movement indicating that he has something to contribute or has decided against contributing it. He does not speak.

The Assessor sets the document down and opens the first register, turning to the relevant section. He reads a passage. He opens the second register. He finds the corresponding section and reads a passage from it. The passages are not identical. They are not contradictory. They occupy adjacent categorical territories without sharing a boundary, a gap between them within which the event under discussion sits with apparent comfort, belonging to neither domain by virtue of occupying the space between them.
\end{action}

\says{Assessor}{It would need to have concluded before it could be properly classified.}

\says{Senior Registrar}{It has concluded.}

\says{Assessor}{The record of its conclusion has not been received.}

\begin{action}
Outside the window, the sounds from the courtyard continue. The activity there has developed since the session began --- voices have increased in number, the movement has intensified, there is now a regularity to certain sounds that suggests a process underway rather than a situation being managed. No one in the room turns toward the window. The window is not treated as a source of relevant information.

The First Clerk examines the document again, attending to its physical condition --- the ink's freshness, the quality of the seal, the paper's provenance, the hand in which it was composed --- as sources of evidence for its classification that might supplement what its content alone supplies. He finds nothing that resolves the question. He sets it down.
\end{action}

\says{First Clerk}{If it were entered as a transfer, the obligations would be different than if entered as a disposition.}

\says{Senior Registrar}{They would be different in ways that have practical consequences.}

\says{Witness}{\upshape (for the first time)} The event itself has no preference.

\begin{action}
The statement produces a brief recalibration in the room's attention --- not because it is unexpected in tone, but because it is accurate in a way that the room's procedures have not required to be stated. The event, already underway and in certain respects concluded, continues to be what it is regardless of its categorical assignment. Its classification will determine how the institutional network responds to it, what obligations it generates, what authority it falls under, what record it occupies. It will not alter the event.

The Senior Registrar writes something in a margin. He does not read it aloud. He closes the second register.
\end{action}

\says{Senior Registrar}{We will enter it under the third register with a supplementary notation pending receipt of the conclusion record.}

\begin{action}
The Clerks begin to prepare the relevant documentation. The Assessor gathers his materials. The Witness does not respond to the determination, which has not addressed his interests in any direction that he would have predicted at the session's opening. He rises and exits. The door closes.

The sounds from the courtyard have changed character. The voices are fewer now, the movement stilled or moved elsewhere, the particular quality of ambience that activity in a bounded space produces has given way to a quieter, more resolved atmosphere whose nature is not determinable from within the room. Whatever was underway out there has reached some condition. The room did not observe it. Its record will reflect a determination reached through the procedures available to a room that could not see its courtyard.

The supplementary notation is written. It is appended. The event, classified and entered, acquires the stability of the recorded. It does not know this has happened. The register closes.
\end{action}
...
% ------------------------------------------------------------
\scenenumber{F --- The Map Being Copied}
% ------------------------------------------------------------

\sceneheading{INT. Cartographic Office --- Day}

\begin{action}
A room whose purpose is the production and maintenance of authoritative spatial representations. Several large sheets occupy the primary table, their surfaces covered with the fine ink work of cartographic draftsmanship --- coastlines, elevation indicators, settlement marks, route lines, boundary notations --- each element placed with a precision that the work's purpose requires and whose achievement demands the kind of sustained, calibrated attention that the room's furnishings and light are organized to support. The light enters from a high window at an angle that minimizes shadow across the working surface, the window's placement having been determined by this functional requirement rather than by any ambient consideration.

A \textsc{Cartographer} works at the central table. Before him: an original map, aged and handled, its surfaces bearing the particular quality of paper that has been consulted many times, its edges softened, its fold lines worn to near-translucency. Beside it, a fresh sheet, substantially blank, receiving the Cartographer's copy. The copy is not yet complete; the eastern region of the territory has been rendered, together with the central routes and the major settlement marks, but the western portions remain as faint preliminary lines awaiting refinement, and certain boundary regions in the south have not yet been attempted.

The original map, examined at close range, is itself a copy. Its provenance is legible in certain features: the border ornamentation in one corner follows conventions that correspond to a particular producing office at a particular period; the lettering of the major settlement names has been done in a hand different from the hand that placed the route lines, suggesting the work of two craftsmen working in sequence; several boundary lines near the document's upper margin have been redrawn, their current positions lying slightly outside the faint traces of an earlier line that was not fully erased before the revision. The map is authoritative. It is also, in multiple detectable respects, a record of prior revisions that have not been recorded as revisions.
\end{action}

\begin{action}
The Cartographer works from the original without consulting other sources. He reproduces what is before him. Where the original's line is certain, his copy's line is certain. Where the original's line is ambiguous --- a boundary rendered in a slightly wavering stroke, a settlement mark whose precise location relative to a route junction is unclear at the original's scale --- the copy resolves the ambiguity in the direction that the Cartographer's experienced hand finds natural, which is to say in the direction of slightly greater regularity, slightly cleaner angles, slightly more assured placement. The copy's line is, in each such instance, more confident than the original. It is also, in each such instance, a decision: the ambiguity of the original has been absorbed into the production process and has not been transmitted into the copy as ambiguity.

He arrives at the section of the original where the redrawn boundary lines are visible. He copies the boundary in its current, revised position. The faint traces of the original line beneath it are not reproduced --- at the copy's scale and with the copy's ink, they are not legible features requiring transmission, and the Cartographer does not attend to them as such. He copies what the original presents as its current authoritative state. The revision history, which the original carries as a physical trace, is not part of what the copy requires.
\end{action}

\begin{action}
By the session's end, the copy is complete. It lies beside the original, both sheets on the table, their contents largely congruent. The differences between them are not legible as errors; each represents what the other cannot fully contain. The copy has resolved the original's ambiguities; the original retains the traces of its own history. The copy is clean. The original is true. Both will be used. Neither will be described as the other.

A \textsc{Clerk} enters to collect the completed copy for dispatch. He examines it briefly, checking its general conformation to the original, and nods. He rolls it carefully. He takes it. He leaves the original on the table. The room is quieter.

The Cartographer cleans his instruments. The original map remains, its surfaces bearing the full physical biography of its production and use --- the different hands, the redrawn lines, the wear of repeated consultation --- while its copy travels toward the offices that requested it, carrying forward the regularized, decided, history-free version of the space it describes. The copy will be consulted. It will, in time, be copied again. Each generation of copies will inherit the decisions of all prior copies without inheriting the ambiguities from which those decisions were made. The map will become increasingly certain. The territory will continue to change.
\end{action}
...
% ------------------------------------------------------------
\scenenumber{17f --- The Library of Contradictions}
% ------------------------------------------------------------

\sceneheading{INT. Archive Room --- Afternoon}

\begin{action}
A room of modest dimensions given over to storage and reference: shelves on three walls bearing bound volumes, rolled documents in wooden cases, flat folios in stacked sequence, the whole organized according to a system whose logic is apparent in certain sections and has been lost or modified in others, the portions of intact organization alternating with portions whose arrangement reflects successive revisions of the system applied to material that was already placed, producing a mixed order neither fully one thing nor fully another. The light enters from a single window, adequate for reading, insufficient for fine work. The room smells of the particular combination of aged paper, stored leather, and enclosed air that characterizes spaces in which documents have been accumulating for longer than the present institutional occupants have been present to manage them.

\textsc{Rorario} has been given access. He enters with a specific question --- the date of a prior negotiation, or the text of an agreement whose terms have been cited in a current dispute, or a record of an appointment whose authority is now being questioned. The question is not exotic; it is the ordinary kind of question that sends an administrator to an archive. He has the room to himself. He begins to look.
\end{action}

\begin{action}
The first document he finds bearing on the question is not the document he was looking for. It is a record of a proceeding that preceded the matter he is investigating, a portion of the institutional history out of which the current question has grown. He reads it. The account it gives is internally coherent. The date is clear. The parties are named. The outcome is described in language that, given the formulations in use at the time of its production, is not ambiguous. He places it on the reading table and continues.

The second document he finds addresses the same proceeding. It is not a copy of the first. It is a separate record, produced by a different hand from a different institutional position, its perspective on the proceeding determined by its author's role within it rather than by any intention to contradict the first account. The account it gives is also internally coherent. The date is consistent with the first document. The parties are named, in some cases by different titles, reflecting the different offices from which each was observed. The outcome is described. It is not the same outcome as the first document's outcome. The difference is not a matter of emphasis or of the selection of what to include. It is a difference in what happened.
\end{action}

\begin{action}
\textsc{Rorario} sets the second document beside the first. He reads the relevant sections of each again, not because a second reading has produced any resolution that the first did not offer but because the first reading produced a result that the mind requires to verify before accepting --- the result being that two honest records of the same event, produced without apparent intention to deceive, describe different events. He verifies. The result holds.

A third document is located, not easily --- it requires the examination of three shelves and two systems of organization before he finds it placed in a location that corresponds to a prior classification rather than the current one, lodged between materials with which it has no current relation but which it was once grouped with on grounds that no longer apply. He extracts it carefully, the paper brittle at the edges where it has been in contact with the adjacent documents. He reads it. The third document does not adjudicate between the first two. It describes the same event from a position that had access to neither of the prior records and therefore reproduces neither their agreements nor their discrepancies, arriving instead at a third account that shares with each of the others one element that it shares with neither.
\end{action}

\begin{action}
He does not attempt to determine which account is correct. This is not incuriosity; it is the recognition, available to someone who has spent a career working with the materials of institutional record, that the question of which account is correct is not one that these documents, jointly, can answer. Each is a remainder of a process: of observation, transcription, transmission, selection, and archive, each stage of which introduced modifications that the subsequent stages cannot recover. The event that generated these three accounts is no longer available at the stage before those modifications began. What the archive holds is not the event but its residues, and the residues disagree in the manner of things that have passed through different processes from the same origin and arrived at different destinations.

A fourth document lies in the same section of shelving, its presence apparent only because one edge projects beyond the volumes beside it. He extracts it. It is brief --- a single page, its text fragmentary, a portion having been lost to water damage that has destroyed the left margin of each line, rendering each sentence readable on its right side and illegible on its left, the surviving portions each insufficient to determine their own context. What can be read coheres with the first account in one respect and with the third in another. The second account is neither confirmed nor contradicted by what survives. The page is returned to its location.
\end{action}

\begin{action}
\textsc{Rorario} remains at the reading table. The three complete documents are before him. He has found what archives contain when they work correctly: not the event, not the truth of the event, not the resolution of questions about the event, but the accumulated record of how the event was observed and transmitted by the institutional systems through which it passed. The archive is not defective. It has produced exactly what archives produce. The three documents are the archive's answer to his question. They are also, and simultaneously, the condition that makes his question unanswerable from within the archive's resources.

He gathers the documents and returns them to their locations --- the first and second to their shelves in the order in which they were found, the third to its anomalous location between materials with which it has no current relation, where it has been and will continue to be. He replaces the fourth document's protruding edge, aligning it with the volumes beside it, and moves to leave.

At the door he pauses, not from any event but from the moment's own weight. The room behind him contains what it has always contained. He has been through it. Nothing has been removed. Nothing has been resolved. The documents persist in their relations, which are the relations of things that were produced at different times by different processes from a shared origin that is no longer present to adjudicate their disagreements. They will be found by others. Others will read them. Others will return them to their shelves. The archive will continue to hold what it has always held, which is everything except the thing itself.

He exits. The room is empty of human presence. The documents occupy the positions in which they were replaced. The afternoon light from the window continues its angle across the reading table's surface, falling now on nothing in particular, illuminating the dust raised by the handling of old paper, which settles again slowly into the still air.
\end{action}

\transition{CUT TO:}

% ------------------------------------------------------------
\scenenumber{17g --- The Library of Revisions}
% ------------------------------------------------------------

\sceneheading{INT. Institutional Archive, Long Room --- Morning}

\begin{action}
A different archive from the one visited in the preceding scene. Larger, better organized, its shelves bearing not the mixed accumulation of an institution that has outgrown its classification system but the deliberate arrangement of a collection that has been maintained with consistent attention across several administrative generations. The room's organization reflects a single scheme applied thoroughly: sections correspond to subjects, subsections to dates, the dating system consistent across the collection and therefore usable as a navigational tool rather than merely a descriptor. This is, in the specific sense of a system that does what it was designed to do, a functional archive.

The long central table is what distinguishes this room from the prior one. It runs nearly the room's full length, its surface capable of accommodating multiple large documents simultaneously in a sequence that can be read from one end to the other without repositioning the documents themselves. It was designed for comparison. It has the character of furniture built for a particular kind of scholarly labor --- extended, sequential, requiring the simultaneous availability of multiple objects along a single axis of inspection.

\textsc{Rorario} arrives with a \textsc{Keeper} who has responsibility for the collection and who has, in response to a specific inquiry submitted through the proper administrative channel, located and assembled the relevant materials in advance of the visit. Five documents lie on the table in sequence, arranged from left to right in chronological order, each separated from its neighbors by a small interval. They concern the same event: a negotiation that preceded by several decades the period in which \textsc{Rorario} has been working, whose terms have become relevant to a current dispute in ways whose resolution requires knowing what, precisely, was agreed.
\end{action}

\begin{action}
The Keeper is a man of exacting professional temperament, committed to the integrity of the collection and practiced in the management of scholarly access to it. He stands slightly to one side, available for questions, not volunteering commentary. He has laid out the documents in the correct order. He considers his primary function in the current scene to be complete.

\textsc{Rorario} begins at the left. The first document is the oldest. It is a direct record of the negotiation, produced at its conclusion by a scribe who was present throughout: its language is dense and technical, carrying the specific terminology of the negotiation as it was conducted, its syntax accommodating the multi-party nature of the agreement through subordinate clauses whose interrelation requires careful parsing. The outcome of the negotiation is stated in these terms without simplification. The document is difficult to read. It is also, within its difficulty, precise.
\end{action}

\begin{action}
The second document is a summary, produced approximately eight months after the first by an official at a different institution who required a condensed account of the negotiation's terms for the purpose of a subsequent proceeding that referenced it. The summary is shorter by two thirds. It is legible where the original is dense. Its simplifications are locally justifiable: each term that has been rendered in plainer language represents a reasonable choice given the secondary audience's needs, each clause that has been merged with an adjacent clause does so without apparent distortion of the overall account. The summary is a competent professional product. Reading it beside the original, \textsc{Rorario} can identify a qualification that has not survived the compression --- a conditional phrase in the original whose conditional nature the summary has absorbed into an unconditional statement, the conditionality dropped because it was peripheral to the summary's purpose and its retention would have complicated the summary's syntax beyond what the secondary audience required.

The conditionality is not there. It is also not flagged as absent. The summary presents itself as a faithful account of what the original contains, and in most respects it is.
\end{action}

\begin{action}
The third document cites the second. It was produced in a jurisdiction where the original was not available --- the original had not been transmitted there, or had been transmitted and lost, or had never been requested because the summary was understood to be sufficient. The third document's author worked from the summary as though from the original, which is to say without the frame of reference that would have made the summary's simplifications visible as simplifications rather than as the negotiation's actual terms. In the third document, the conditional phrase that did not survive into the second document is not merely absent; it is structurally impossible within the account the third document gives, because the third document has built an interpretation of the negotiation's terms upon the unconditional version that the summary presented, and an unconditional account and a conditional account are not interchangeable at the level of their interpretive consequences. What the third document holds is not the negotiation. It is an interpretation of a summary of the negotiation, rendered with the authority that accrues to documents produced from apparent primary sources and transmitted through institutional channels with proper seals.

\textsc{Rorario} sets the third document down. He picks up the first document again. He reads the conditional phrase. He reads the unconditional statement in the second document. He returns to the third document's interpretation of the unconditional statement. The distance between the first document and the third is not large in number of words. It is very large in what those words commit.
\end{action}

\begin{action}
The fourth document is a translation. The negotiation had involved parties whose primary working language was not Latin, and the third document, circulating in that administrative network, had eventually been rendered into a second language by a translator whose command of both languages was adequate and whose command of the specific technical domain was not. Terms of art in the third document had been translated by their closest semantic equivalents in the target language, which were not the same terms. The closest equivalent carried a slightly different range of application, its boundaries determined by the jurisprudential tradition of the target language rather than the source tradition. The translation is not wrong by the standards available to its author. It is, by the standards available to someone reading it beside the original, carrying a slightly different set of implications than the terms it was translating carried --- a shift detectable only to someone with complete fluency in both traditions, which the translator had not been required to possess and the document's subsequent users had not been informed to seek.

The fifth document cites the fourth. It is the most recent of the five, produced within the administrative memory of some of the current dispute's participants, and it carries an authority proportionate to its recency and the institutional standing of its source. Its account of the negotiation's terms proceeds from the translated version with the confidence that proximity and institutional standing confer. It is clean. It is well organized. It is internally consistent. It has no visible relationship to the difficult, technical, conditional first document lying to its left at the table's far end, though it purports to describe the same event.

\textsc{Rorario} stands at the table's right end, the fifth document before him. He looks left along the table's length. The five documents lie in their sequence, separated by their small intervals, each complete in itself, each produced honestly, each a reasonable response to the institutional situation that generated it. He can see all five simultaneously. No one else in the history of this question has been positioned to see all five simultaneously. Most have seen one or two. Some have seen three. The fifth document's authors worked from the fourth alone. The dispute that has sent \textsc{Rorario} to this table was generated by the fifth document's account of terms that the first document established differently.
\end{action}

\begin{action}
The Keeper stands at a respectful distance.

\textsc{Rorario} reads the fifth document again, attending this time not to its content but to a phrase in its third section --- a phrase he does not recognize from the preceding four documents, a formulation that does not appear in the first document, or the second, or the third, or the fourth. He reads the fourth document's corresponding section. The phrase is not there, but its elements are present, adjacent and unjoined. He reads the third. Adjacent and unjoined. He reads the second. One element is present; the other is in a different section entirely, in a different context, not associated with the term it will eventually come to modify. He reads the first. Neither element, in the form in which they appear in the fifth document, is present at all.

The phrase in the fifth document has no author. It was not inserted. It was not invented. It emerged from the sequence of transmissions that connect the first document to the fifth, each transmission doing what transmissions do --- clarifying, compressing, regularizing, translating, contextualizing --- and the phrase is what those operations produced when performed in that order on that material by those hands at those intervals. It is the archive's own composition. It will be cited. It will be treated as a record of what was agreed. It will generate obligations. It will be transmitted further.

\textsc{Rorario} does not read the phrase aloud. There is no one to read it to. He stands at the table's right end and looks left along the length of the five documents and the question he came to answer is no longer the question he is occupied with, because the question he came to answer has been answered, in the sense that the archive has shown him exactly what happened to the negotiation's terms, and the answer is that nothing happened to them --- nothing went wrong, no corruption event occurred, no document was falsified, no scribe exceeded his authority --- and the terms are nevertheless not present in the record that governs the current dispute. They are present only here, in this room, on this table, in the first document at the table's left end, which is correct and which no one currently party to the dispute has read and which will remain here when he leaves.
\end{action}

\begin{action}
He turns to the Keeper.
\end{action}

\says{Rorario}{Is there an index of which documents have cited this one.}

\begin{action}
The Keeper considers.
\end{action}

\says{Keeper}{There is a record of transmissions. It is not complete for the earlier period.}

\says{Rorario}{The fifth document. Do you know whether it has been copied.}

\says{Keeper}{Several times. It is in wide use.}

\begin{action}
A brief interval. \textsc{Rorario} looks at the table. The five documents remain in their sequence. The phrase in the fifth document --- the phrase without an author, the phrase that the sequence composed --- is already in wide use. It has already been copied. It is already generating further documents from which it will not be absent and toward which it will carry the authority of the document from which they copy it. The archive will continue to extend itself. The phrase will continue.

He thanks the Keeper. He does not ask for copies of the documents. He cannot use them; the dispute that sent him here operates in the administrative network that knows the fifth document and does not know the first, and the first document's correction of the fifth would require a chain of demonstration that the dispute's current procedures have no mechanism to accommodate. The correction exists. It is correct. It is here. It will remain here.

He exits. The Keeper remains. The documents remain on the long table in their sequence, awaiting return to their shelves, which will separate them again into the sections of the archive that their individual dates and subjects assign them. Separated, they will no longer form a sequence. The sequence exists only on the table, only when arranged, only when all five are present and a single observer stands at one end and looks along their length. The Keeper begins, at the table's left end, to gather them.
\end{action}
